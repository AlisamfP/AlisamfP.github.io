...
export const ExperienceItem: React.FC<ExperienceItemProps> = ({ job }) => (
  ...
  >
    <div className="grid grid-cols-2 justify-between align-baseline">
      <h3 itemProp="roleName" className="text-xl font-semibold">
        {job.role}
      </h3>
...
//               </p>
//             </div>
//             <div itemProp="memberOf" itemScope itemType="https://schema.org/Organization" className="-mt-0.5">
//               <span itemProp="name">{job.company}</span>,{" "}
//               <span itemProp="location">{job.location}</span>
//             </div>
...
//             <ul className="list-inside grid grid-cols-2 gap-2 pb-2" itemProp="skills">
